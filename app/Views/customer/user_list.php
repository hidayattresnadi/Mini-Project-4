...
<div class="container mt-4">
    <h1 class="mb-4">List Customers</h1>
    <form method="get" action="<?= site_url('admin/customers') ?>" class="form-inline">
...
<div class="container mt-4">
    <a href="<?= site_url('admin/customers/create') ?>" class="btn btn-success mb-3">Add Customer</a>
            ...
            <tbody>
                <?php foreach ($customers as $customer): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($customer->last_login) ?></td>
                        <td>
                            <a href="<?= site_url('admin/customers/profile/' . $customer->id) ?>" class="btn btn-primary btn-sm">
                        ...
                        <td>
                            <a href="<?= site_url('admin/customers/edit/' .  $customer->id) ?>" class="btn btn-warning btn-sm">
                        ...
                        <td>
                            <form action="<?= site_url('admin/customers/delete/' . $customer->id) ?>" method="post" class="d-inline">
                                <?= csrf_field() ?>
...
<?= $pager->links('customers', 'custom_pager') ?>
<?= $this->endSection() ?>