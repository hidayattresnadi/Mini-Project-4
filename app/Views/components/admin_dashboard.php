        ...
        <div class="col-md-6">
            <div class="card text-white bg-primary mb-3">
                <div class="card-body d-flex align-items-center justify-content-center flex-column h-100 p-4">
                    ...
                    <h5 class="card-title fs-3 mt-3">Total Active Products</h5>
                    <p class="card-text fs-2">{activeProducts}</p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card text-white bg-success mb-3">
                <div class="card-body d-flex align-items-center justify-content-center flex-column h-100 p-4">
                    ...
                    <h5 class="card-title fs-3 mt-3">Total Products</h5>
        ...
        <div class="col-md-6">
            <div class="card text-white bg-warning mb-3">
                <div class="card-body d-flex align-items-center justify-content-center flex-column h-100 p-4">
                    ...
                    <h5 class="card-title fs-3 mt-3">On Sale Products</h5>
                    <p class="card-text fs-2">{onSaleProducts}</p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card text-white bg-danger mb-3">
                <div class="card-body d-flex align-items-center justify-content-center flex-column h-100 p-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-tags-fill" viewBox="0 0 16 16">
                        <path d="M2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586zm3.5 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3" />
                        <path d="M1.293 7.793A1 1 0 0 1 1 7.086V2a1 1 0 0 0-1 1v4.586a1 1 0 0 0 .293.707l7 7a1 1 0 0 0 1.414 0l.043-.043z" />
                    </svg>
                    <h5 class="card-title fs-3 mt-3">Out of Stock Products</h5>
                    <p class="card-text fs-2">{outOfStock}</p>
