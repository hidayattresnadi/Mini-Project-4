...
<div class="container mt-5">
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form id="formData" method="post" action="<?= site_url('admin/roles/update/' . $role->id) ?>">
                <?= csrf_field() ?>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control" id="description" rows="5" placeholder="Enter description"
                        ...
                        data-pristine-maxlength-message="Description Cannot exceed 255 characters"><?= esc($role->description ?? '') ?></textarea>
                </div>
